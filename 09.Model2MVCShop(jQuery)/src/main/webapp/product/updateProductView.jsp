...
<body bgcolor="#ffffff" text="#000000">
	...
	<form name="detailForm" method="post">
		<input type="hidden" name="prodNo" class="ct_input_g"
			value=${product.prodNo}> <input type="hidden" name="menu"
			class="ct_input_g" value=${param.menu}>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="manuDate"
					class="ct_input_g" value=${product.manuDate
					}
						style="width: 100px; height: 19px" maxLength="10"
					minLength="6" /> &nbsp;<img src="../images/ct_icon_date.gif"
					width="15" height="15"
			...
			<tr>
				...
				<td class="ct_write01"><input type="text" name="price"
					class="ct_input_g" value="${product.price}"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01"><input type="text" name="total"
					class="ct_input_g" value="${product.total}"
					style="width: 100px; height: 19px" maxLength="10">&nbsp;개</td>
			</tr>
			...
			<tr>
				...
				<td class="ct_write01"><input type="file" name="fileName"
					class="ct_input_g" value="${product.fileName}"
					style="width: 200px; height: 25px" maxLength="13" /></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
