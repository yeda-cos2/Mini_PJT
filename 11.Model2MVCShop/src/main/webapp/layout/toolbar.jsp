...
<style>
.navbar-brand { font-family: '바탕'; font-weight:bold; color:brown}
.navbar-brand li { font-family: '바탕'}
.navbar-header { font-family: '바탕'}
.nav { font-family: '바탕'; font-weight:bold; color:brown}
.navbar-right { font-family: '바탕'}
.navbar-fixed-top { font-family: '바탕'}
.navbar-default { font-family: '바탕'}
.navbar-toggle { font-family: '바탕'}
.navbar-collapse { font-family: '바탕'}
