...
<link href="https://fonts.googleapis.com/css2?family=Gowun+Batang&display=swap" rel="stylesheet">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f06d31450aeb08260bb47968cf12ac89"></script>
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-6">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="아이디" required oninput="checkDuplication()"/>
        ...
        new daum.Postcode({
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-default"  >가 &nbsp;입</button>
