...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${product.total}</td>
	</tr>
	...
	<tr>
		...
		<img src="/images/uploadFiles/${name}" width="300" height="300">
		</c:forEach>
		</td>
		</c:when>
		<c:otherwise>
	...
	<tr>
		...
		<td align="right">
			...
			<tr>
				...
				<a href="/purchase/addPurchase?prodNo=${product.prodNo}&menu=${param.menu}">구매</a>
				</c:if>	
				</td>
